...
export default{
  ...
  methods: {
    fnGetQuestion: function(){
      axios.get("http://ampm.com:8088/api/question/"+this.id,{
    ...
    fnGetAnswer: function(){
      axios.get("http://ampm.com:8088/api/answer/"+this.id,{
      }).then((res) => {
        console.log(res)
    ...
    fnQdelete: function(){
      Swal.fire({
            ...
            if(result.isConfirmed){
              axios.delete("http://ampm.com:8088/api/question/"+this.id,{})
                .then(() => {
                  Swal.fire({
                    icon: 'success',
                    title: 'SUCCESS!',
    ...
    fnASave(){
      let apiUrl = "http://ampm.com:8088/api/answer/write"
      this.form = {
        "questionId": this.id,
        "title": this.Atitle,
    ...
    fnAdelete(){
      Swal.fire({
            ...
            if(result.isConfirmed){
              axios.delete("http://ampm.com:8088/api/answer/"+this.id)
                .then(result => {
                  console.log(result)
                  Swal.fire({
                      icon: 'success',
